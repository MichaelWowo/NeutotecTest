package com.neurotec.tutorials.biometrics.camera;
...
import com.neurotec.tutorials.biometrics.CredenceLivenessDetection;
...
public class PreviewFrameLayout
    ...
    onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            ((CredenceLivenessDetection) getContext()).performTapToFocus(touchRect);
        }
        return true;
    }
}